...
render_engine = load_ui_engine(__file__, "horario", "engine_render")
teacher_engine = load_ui_engine(__file__, "horario", "engine_teachers")
...
class HorarioView:
    ...
    def _render_selected_sheet(self) -> None:
        render_engine.render_selected_sheet(self)
    ...
    def _build_global_teacher_index(self) -> None:
        teacher_engine.build_global_teacher_index(self)
    ...
    def _extract_course_alias_pairs(self, cell_text: str) -> list[tuple[str, list[str]]]:
        return teacher_engine.extract_course_alias_pairs(self, cell_text)
    ...
    def _tchr_norm_name(self, text: str) -> str:
        return teacher_engine.tchr_norm_name(text)

    def _sync_block_selector(self, blocks: list[tuple[list[str], list[list[str]]]]) -> None:
        render_engine.sync_block_selector(self, blocks)

    def _slot_hours(self, slot_label: str) -> float:
        return teacher_engine.slot_hours(self, slot_label)

    def _build_daily_hours_summary_items(self, schedule_rows: list[list[str]]) -> list[str]:
        return teacher_engine.build_daily_hours_summary_items(self, schedule_rows)

    def _build_group_hours_summary_items(self, schedule_rows: list[list[str]]) -> list[str]:
        return teacher_engine.build_group_hours_summary_items(self, schedule_rows)
