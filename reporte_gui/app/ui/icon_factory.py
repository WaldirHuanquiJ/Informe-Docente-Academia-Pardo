...
def make_calendar_icon(size: int = 20) -> QIcon:
    return _make_symbol_icon("◫", size, "#1f2f3e", "#4f7fa8", "#d7efff")


def make_check_all_icon(size: int = 20) -> QIcon:
    return _make_symbol_icon("✓", size, "#143326", "#2f8f67", "#c8ffe8")


def make_uncheck_all_icon(size: int = 20) -> QIcon:
    return _make_symbol_icon("☐", size, "#3a1d1d", "#9f4c4c", "#ffdede")


def make_load_month_icon(size: int = 20) -> QIcon:
    return _make_symbol_icon("⟳", size, "#1f2f3e", "#4f7fa8", "#d7efff")


def make_save_icon(size: int = 20) -> QIcon:
    return _make_symbol_icon("💾", size, "#2d1f43", "#6e50a8", "#e7d9ff")
